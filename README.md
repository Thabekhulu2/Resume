...
|---|---|---|--:|--:|--:|--:|
| `helm` | ❌ `failed` [↗](https://github.com/Thabekhulu2/Resume/actions/runs/32886112095) | — | — | — | 0 | 1 |
| `seed` | ❌ `failed` [↗](https://github.com/Thabekhulu2/Resume/actions/runs/32886112095) | — | — | — | 0 | 1 |
